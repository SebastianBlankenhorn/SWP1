...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        pnl_Main = new JPanel();
        pnl_Main.setLayout(new com.intellij.uiDesigner.core.GridLayoutManager(2, 1, new Insets(0, 0, 0, 0), -1, -1));
        pnl_Main.setName("panel1");
        pnl_Main.setVisible(true);
        menuBar = new JMenuBar();
        menuBar.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
        menuBar.setBackground(new Color(-1));
        menuBar.setForeground(new Color(-1));
        menuBar.setInheritsPopupMenu(true);
        pnl_Main.add(menuBar, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_NORTH, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        datei = new JMenu();
        datei.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
        datei.setText("Datei");
        menuBar.add(datei);
        mit_Teilnehmen = new JMenuItem();
        mit_Teilnehmen.setText("Teilnehmen");
        datei.add(mit_Teilnehmen);
        mit_Verlassen = new JMenuItem();
        mit_Verlassen.setText("Verlassen");
        datei.add(mit_Verlassen);
        final JMenuItem menuItem1 = new JMenuItem();
        menuItem1.setText("-------------");
        datei.add(menuItem1);
        mit_Neu = new JMenuItem();
        mit_Neu.setText("Neu");
        datei.add(mit_Neu);
        mit_Oeffnen = new JMenuItem();
        mit_Oeffnen.setText("Öffnen");
        datei.add(mit_Oeffnen);
        mit_Speichern = new JMenuItem();
        mit_Speichern.setText("Speichern");
        datei.add(mit_Speichern);
        mit_SpeichernAls = new JMenuItem();
        mit_SpeichernAls.setText("Speichern als");
        datei.add(mit_SpeichernAls);
        mit_Schliesen = new JMenuItem();
        mit_Schliesen.setText("Schließen");
        datei.add(mit_Schliesen);
        final JMenuItem menuItem2 = new JMenuItem();
        menuItem2.setText("-------------");
        datei.add(menuItem2);
        mit_Beenden = new JMenuItem();
        mit_Beenden.setText("Beenden");
        datei.add(mit_Beenden);
        bearbeiten = new JMenu();
        bearbeiten.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
        bearbeiten.setText("Bearbeiten");
        menuBar.add(bearbeiten);
        mit_AendereMase = new JMenuItem();
        mit_AendereMase.setText("Maße ändern");
        bearbeiten.add(mit_AendereMase);
        final JMenuItem menuItem3 = new JMenuItem();
        menuItem3.setText("-------------");
        bearbeiten.add(menuItem3);
        mit_Schneller = new JMenuItem();
        mit_Schneller.setText("Schneller");
        bearbeiten.add(mit_Schneller);
        mit_Langsamer = new JMenuItem();
        mit_Langsamer.setText("Langsamer");
        bearbeiten.add(mit_Langsamer);
        final JMenuItem menuItem4 = new JMenuItem();
        menuItem4.setText("-------------");
        bearbeiten.add(menuItem4);
        mit_Starten = new JMenuItem();
        mit_Starten.setText("Starten");
        bearbeiten.add(mit_Starten);
        mit_Anhalten = new JMenuItem();
        mit_Anhalten.setText("Anhalten");
        bearbeiten.add(mit_Anhalten);
        hilfe = new JMenu();
        hilfe.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
        hilfe.setText("Hilfe");
        menuBar.add(hilfe);
        mit_Anleitung = new JMenuItem();
        mit_Anleitung.setText("Anleitung");
        hilfe.add(mit_Anleitung);
        final JMenuItem menuItem5 = new JMenuItem();
        menuItem5.setText("-------------");
        hilfe.add(menuItem5);
        mit_Ueber = new JMenuItem();
        mit_Ueber.setSelected(false);
        mit_Ueber.setText("Über");
        hilfe.add(mit_Ueber);
        panelHolder = new PanelHolder();
        pnl_Main.add(panelHolder.$$$getRootComponent$$$(), new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
    }
